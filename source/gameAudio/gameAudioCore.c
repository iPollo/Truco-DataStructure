...
void gameAudioInit(){
	...
	gameSound[SFX_CARD] = LoadSound(TextFormat("%s/gameAssets/sfx/SFX_CARD.mp3", GetWorkingDirectory()));
	gameSound[SFX_CARDAWAY] = LoadSound(TextFormat("%s/gameAssets/sfx/SFX_CARDAWAY.mp3", GetWorkingDirectory()));
	gameSound[SFX_TRUCO] = LoadSound(TextFormat("%s/gameAssets/sfx/SFX_TRUCO.mp3", GetWorkingDirectory()));
	gameSound[SFX_ACCEPT] = LoadSound(TextFormat("%s/gameAssets/sfx/SFX_ACCEPT.mp3", GetWorkingDirectory()));
	gameSound[SFX_REJECT] = LoadSound(TextFormat("%s/gameAssets/sfx/SFX_REJECT.mp3", GetWorkingDirectory()));
